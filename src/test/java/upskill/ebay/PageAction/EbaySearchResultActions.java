...
public class EbaySearchResultActions {
	...
	/*
	 * public void verifyBrandItems(String brand){ if(brand.equals("Adidas")){
	 * Assert.assertEquals("Shirts",
	 * EbaySearchResultLocatorsObj.txtShirts.getText()); } else
	 * if(brand.equals("Nike")){ Assert.assertEquals("Shoes",
	 * EbaySearchResultLocatorsObj.txtShoes.getText()); } else
	 * if(brand.equals("Unbranded")){ Assert.assertEquals("Pants",
	 * EbaySearchResultLocatorsObj.txtPants.getText()); } else {
	 * System.out.println("Brand not found"); } }
	 * 
